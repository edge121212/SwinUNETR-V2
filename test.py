...
parser.add_argument("--task", default="Prostate", type=str, help="MSD Task name (Prostate, Lung, Pancreas)")
parser.add_argument("--fold", default=0, type=int, help="cross validation fold (0-4)")
...
def main():
    ...
    if "prostate" in task_lower:
        args.in_channels = 2
        args.out_channels = 3
        args.json_list = "dataset.json"
    elif "lung" in task_lower:
        args.in_channels = 1
        args.out_channels = 2
        args.json_list = "dataset.json"
    elif "pancreas" in task_lower:
        args.in_channels = 1
        args.out_channels = 3
        args.json_list = "dataset.json"
